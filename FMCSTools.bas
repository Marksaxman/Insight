...
Do While f.atendofstream <> True
    ...
    If InStr(thisline, "Point System Name:") Then
        ...
        ' Write Point Information to worksheet
        ActiveCell.Offset(0, 22).Value = "Y"
        'ActiveCell.Offset(0, 31).Value = "Y"
        'ActiveCell.Offset(0, 32).Value = "Y"
...
Do While f.atendofstream <> True
    ...
    If ((Mid(thisline, 2, 1) >= "0") And (Mid(thisline, 2, 1) <= "Z")) Then
        ...
        'Extract point system name
        Tempvar = InStr(thisline, ",")
        PointName = Mid(thisline, 2, (Tempvar - 3))
    ...
    ' Write Point Information to worksheet
    ActiveCell.Offset(0, 22).Value = RENORTN
    ActiveCell.Offset(0, 23).Value = RENOFailed
    ActiveCell.Offset(0, 24).Value = RENOPri1
    ActiveCell.Offset(0, 25).Value = RENOPri2
    ActiveCell.Offset(0, 26).Value = RENOPri3
    ActiveCell.Offset(0, 27).Value = RENOPri4
    ActiveCell.Offset(0, 28).Value = RENOPri5
    ActiveCell.Offset(0, 29).Value = RENOPri6
Loop
